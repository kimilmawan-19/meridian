...
// Escape dynamic content (token symbols / narratives) before inserting into an HTML message.
// Telegram parse_mode=HTML rejects the WHOLE message (HTTP 400) on a stray &, <, or >.
